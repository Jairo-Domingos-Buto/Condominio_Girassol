...
@section('title', 'Cadastrar Visita')
...
<section id="auth">
    ...
    <form action="{{ route('customCreate.create') }}" method="POST" class="row-wrap">
        ...
        <div class="divider">
            ...
            <input type="text" name="user_type" id="" required value="visita" hidden>
        </div>
...
<script>
    var active = document.querySelector("#side-cadastrar-visita");
    var activeImg = document.querySelector('#side-cadastrar-visita img');
</script>
