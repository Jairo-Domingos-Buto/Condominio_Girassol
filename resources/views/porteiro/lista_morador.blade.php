...
<section id="lista">
    <div class="inline-search">
        <form action="" method="" id="formSelect">
            <div class="search">
                <input type="search" name="" id="" placeholder="Nome do morador...">
...
<script>
    var active = document.querySelector("#side-lista-morador")
    var activeImg = document.querySelector('#side-lista-morador img')
