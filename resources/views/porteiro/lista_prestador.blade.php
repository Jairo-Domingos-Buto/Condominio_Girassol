...
<div class="inline-search">
        <form action="" method="" id="formSelect">
            <div class="search">
                <input type="search" name="" id="" placeholder="Nome do prestador de serviços...">
...
<script>
    var active = document.querySelector("#side-lista-prestador")
    var activeImg = document.querySelector('#side-lista-prestador img')
